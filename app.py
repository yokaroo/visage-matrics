...
try:
    ...
    print(f"[WARNING] Could not import auth_routes: {str(e)}")
    register_auth_routes = None

try:
    from routes.inference_routes import register_inference_routes, set_model as set_inference_model
except Exception as e:
    print(f"[WARNING] Could not import inference_routes: {str(e)}")
    register_inference_routes = None
    set_inference_model = None
